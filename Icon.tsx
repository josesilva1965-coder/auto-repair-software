...
export const WrenchScrewdriverIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.87-5.87m0 0L11.42 15.17m5.87-5.87L15.17 11.42m5.87-5.87L17.25 3l-5.87 5.87m0 0L11.42 3l5.87 5.87M3 21l6-6m0 0 6-6M3 21l6-6m0 0-6 6" />
  </svg>
);
...
export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.75-5.25T21 9.75a9 9 0 0 0-18 0 9.094 9.094 0 0 0 3.75 5.25m10.5 0a2.25 2.25 0 0 1-2.25 2.25h-6.75a2.25 2.25 0 0 1-2.25-2.25M15 11.25a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
);
...
export const CarIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H6.624a2.056 2.056 0 0 0-1.58.86 17.903 17.903 0 0 0-3.213 9.193c-.039.62.468 1.124 1.09 1.124h1.125" />
    </svg>
);
...
export const CurrencyDollarIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.826-1.106-2.156 0-2.982C10.544 7.219 11.275 7 12 7c.725 0 1.45.22 2.003.659" />
    </svg>
);
...
export const IdentificationIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h6m3-3.75l-3.75 3.75M17.25 19.5l-3.75-3.75m0 0A2.25 2.25 0 0 1 15 12a2.25 2.25 0 0 1 2.25 2.25a2.25 2.25 0 0 1-2.25 2.25a2.25 2.25 0 0 1-2.25-2.25Z" />
    </svg>
);
...
export const CalendarDaysIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0h18M12 11.25h.008v.008H12v-.008Zm0 3h.008v.008H12v-.008Zm.008-3h.008v.008H12.008V11.25Zm-3 0h.008v.008H9v-.008Zm0 3h.008v.008H9v-.008Zm.008-3h.008v.008H9.008V11.25Zm3 3h.008v.008H12v-.008Zm.008-3h.008v.008H12.008V11.25Zm-3 3h.008v.008H9v-.008Zm0-3h.008v.008H9v-.008Z" />
    </svg>
);

export const BanknotesIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-15c-.621 0-1.125-.504-1.125-1.125V8.25m18-3.75v.75c0 .414-.336.75-.75.75h-.75a1.125 1.125 0 0 1-1.125-1.125V4.5m1.5.75v-.75a.75.75 0 0 0-.75-.75H3.75a.75.75 0 0 0-.75.75v.75m15 6.75h-6.25a1.5 1.5 0 0 1-1.5-1.5v-1.5a1.5 1.5 0 0 1 1.5-1.5H15m0 4.5h.75a.75.75 0 0 0 .75-.75v-3a.75.75 0 0 0-.75-.75h-.75m-6.25 0H8.625c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125h2.25m-3-4.5v.75c0 .414.336.75.75.75h.75M15 12h-3v-3h3v3Z" />
    </svg>
);
...
export const ArrowTrendingUpIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.28m5.94 2.28L21 4.99" />
    </svg>
);
...
export const UserGroupIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.75-5.25T21 9.75a9 9 0 00-18 0 9.094 9.094 0 003.75 5.25m10.5 0a2.25 2.25 0 01-2.25 2.25h-6.75a2.25 2.25 0 01-2.25-2.25M12 15c-2.22 0-4-1.78-4-4s1.78-4 4-4 4 1.78 4 4-1.78 4-4 4zm-9-4a9 9 0 0118 0" />
    </svg>
);

export const BriefcaseIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.972 2.4-2.215 2.541-1.393.153-2.615-.84-2.615-2.206V14.15m0 0a2.25 2.25 0 00-2.25-2.25H8.25a2.25 2.25 0 00-2.25 2.25v4.925c0 1.366-1.222 2.359-2.615 2.206C2.22 20.625 1.25 19.537 1.25 18.225V6.75a2.25 2.25 0 012.25-2.25h16.5a2.25 2.25 0 012.25 2.25v7.4Z" />
  </svg>
);
...
export const Cog6ToothIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.226a2.25 2.25 0 012.59 0c.55.219 1.02.684 1.11 1.226M9.594 20.06c.09.542.56 1.007 1.11 1.226a2.25 2.25 0 002.59 0c.55-.219 1.02-.684 1.11-1.226m-4.8 0A2.25 2.25 0 007.5 21a2.25 2.25 0 00-2.25-2.25m4.5 0A2.25 2.25 0 0116.5 21a2.25 2.25 0 012.25-2.25m-13.5 0a2.25 2.25 0 00-2.25 2.25c0 .59.22 1.12.586 1.5M4.5 9.594c-.09-.542-.56-1.007-1.11-1.226a2.25 2.25 0 00-2.59 0c-.55.219-1.02.684-1.11 1.226M19.5 9.594c.09-.542.56-1.007 1.11-1.226a2.25 2.25 0 00-2.59 0c-.55.219-1.02.684-1.11 1.226M12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
    </svg>
);
